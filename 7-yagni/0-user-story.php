...
|--------------------------------------------------------------------------
|
| The resources are saved in a database and through a handler, I should be
| be able to get the list of resources objects, so then I could list them on
| the user interface.
|
| It is important to note that these resources would potentially be between
| 10 - 50 items maximum.
|
|
| Acceptance Criteria
